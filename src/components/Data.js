export const Data = [
    ...
    sequences: [
      {
        ...
        description: (
          <>
            ...
            <p>Supplementary Ingredients:</p>
            <ul>
              <li>10 drops of Goat's Beard Hydrosol.</li>
              <li>90 milliliters of Ancient Well Water.</li>
              <li>1 flower grown from a corpse.</li>
              <li>5 grams of Spirit World-contaminated soil.</li>
            </ul>
          </>
        ),
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Supplementary Ingredients:</p>
            <ul>
              <li>5 milliliters of essential oils made from Hornbeam.</li>
              <li>10 grams of String Grass Powder.</li>
              <li>A blossoming Red Chestnut Flower.</li>
              <li>80 milliliters of Purified Water.</li>
            </ul>
          </>
        ),
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Supplementary Ingredients:</p>
            <ul>
              <li>10 grams of Clematis Powder.</li>
              <li>1 segment of Withered Grapevine.</li>
              <li>1 pair of any Octopus Eyeballs.</li>
              <li>80 milliliters of Strong Liquor.</li>
            </ul>
          </>
        ),
        card: require("../assets/cards/1_Card.webp"),
      },
      {
        ...
        description: (
          <>
            ...
            <p>Supplementary Ingredients:</p>
            <ul>
              <li>3 Diary Pages over 22 years old.</li>
              <li>10 milliliters of Mercury.</li>
              <li>10 drops of Honeysuckle Essential Oil.</li>
              <li>
                30 milliliters of Seawater, Lake Water, Glacier Water each.
              </li>
            </ul>
          </>
        ),
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Supplementary Ingredients:</p>
            <ul>
              <li>10 grams of Trapped Ghost Residue Powder.</li>
              <li>10 grams of Lemon Balm Powder.</li>
              <li>1 Star Chart drawn with Spirit Blood.</li>
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Supplementary Ingredients:</p>
            <ul>
              <li>Siskun Demon Worm’s Nest.</li>
              <li>
                Ankh Gate’s Ashes (can be substituted with Golden Phoenix
                Feathers).
              </li>
              <li>1 walnut.</li>
              <li>
                100 milliliters of Lake Water freshly reflecting the starry sky.
              </li>
            </ul>
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Supplementary Ingredients:</p>
            <ul>
              <li>10 milliliters of Wandering Skin’s Pus.</li>
              <li>Mist Watcher’s Eyelid.</li>
              <li>9 white mustard seeds.</li>
            ...
            <p>
              ...
              record everything down in full detail and do not forget them.
            </p>
          </>
        ),
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Main Ingredients:</p>
            <ul>
              <li>The Door Uniqueness.</li>
              <li>
                All other Key of Stars Beyonder Characteristics apart from one's
                own.
              </li>
            </ul>
            ...
            <ul>
              <li>
                Mastery of astronomical, geographical, and folkloric knowledge
                of at least three galactic systems.
              </li>
            </ul>
  ...
  // Paragon
  {
    ...
    neighbors: [
      {
        id: 9,
        iconOff: require("../assets/iconOff/9_Off.png"),
    ...
    sequences: [
      {
        ...
        description: (
          <>
            ...
            <p>Supplementary Ingredients:</p>
            <ul>
              <li>100 milliliters of High Mountain Snowman blood.</li>
              <li>1 item bearing stains of a Library Shadow Spirit.</li>
              <li>1 basic education textbook.</li>
              <li>1 piece of a Carnelian.</li>
            </ul>
          </>
        ),
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Main Ingredients:</p>
            <ul>
              <li>The Crystallization of an Ancient Tomb Shadow.</li>
              <li>
                The Spinal Cord of a Ruin Wanderer
                <br />
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Supplementary Ingredients:</p>
            <ul>
              <li>150 milliliters of Four-Armed Madman blood.</li>
              <li>30 grams of ashes from the Carnivorous Furnace.</li>
              <li>
                1 piece of personally polished gear or another mechanical
                component.
              </li>
              <li>
                1 newly conceived mechanical design drawing, free from major
                errors.
              </li>
            </ul>
          </>
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Supplementary Ingredients:</p>
            <ul>
              <li>200 milliliters of a Star marked Elephant Man blood.</li>
              <li>
                3 fragments of ordinary shell from the Enchanted Dancing Giant
                Turtle.
              </li>
              <li>1 complete set of convex and concave lenses.</li>
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Supplementary Ingredients:</p>
            <ul>
              <li>100 milliliters of Soul Eater blood.</li>
              <li>
                1 core component of a mechanical construct belonging to a Spirit
                of Machinery.
              </li>
              <li>1 piece of one’s own flesh and blood.</li>
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <ul>
              <li>
                1 kindle of Spirit World Meteor
                <br />
                Or 1 object once possessed by an Arcane Scholar.
              </li>
              <li>
                30 grams of dust from Annihilation Ghost
                <br />
                Or 40 grams of dust from an Arcane Scholar.
              </li>
              <li>90 milliliters of water contaminated by the Spirit World.</li>
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <ul>
              <li>
                5,000 milliliters of water from the "Knowledge Sea" formed after
                the death of a Knowledge Magister or the “Otherworldly Brain”.
              </li>
              <li>
                One copy of one's own work that has been cited or utilized by
                more than 100,000 people (On paper).
              </li>
              <li>
                A blessing from any of the Seven Lights of the Spirit World.
              </li>
              <li>
                Heartfelt tokens of gratitude from different students of the
                concoctor (One thousand).
              </li>
            </ul>
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Main Ingredients:</p>
            <ul>
              <li>An Illuminator Beyonder Characteristic.</li>
            </ul>

            <p>Supplementary Ingredients:</p>
            <ul>
              <li>
                100,000 souls of those who perished during a civilization's
                decline.
              </li>
              <li>1 History book recording a civilization.</li>
              <li>
                1 of the most outstanding mechanical creations from a
                civilization (It must be near perfect).
              </li>
              <li>
                12 miniature idols sculpted by one's students out of worship and
                faith.
              </li>
            </ul>
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Main Ingredients:</p>
            <ul>
              <li>The Paragon Symbol2 Paragon Uniqueness.</li>
              <li>
                All other Illuminator Beyonder Characteristics apart from one's
                own.
              </li>
            </ul>
            ...
            <ul>
              <li>
                Knowledge gleaned from the Aura or remnants of the Great Old
                Ones.
              </li>
            </ul>
  ...
  // Demoness
  {
    ...
    neighbors: [
      {
        id: 7,
        iconOff: require("../assets/iconOff/7_Off.png"),
    ...
    sequences: [
      {
        ...
        description: (
          <>
            ...
            <p>Supplementary Ingredients:</p>
            <ul>
              <li>100 milliliters of strong vinegar.</li>
              <li>Three petals of the Shadow Poison Flower.</li>
              <li>10 drops of buttercup essential oil.</li>
              <li>One live spider.</li>
            </ul>
          </>
        ),
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Supplementary Ingredients:</p>
            <ul>
              <li>100 milliliters of Purified Water.</li>
              <li>Syrinx of the Demon Throat Honeyguide.</li>
              <li>5 drops of Blue Jimsonweed Juice.</li>
              <li>10 grams of Aqua Fern Grass Powder.</li>
              <li>An unpeeled walnut.</li>
            </ul>
          </>
        ),
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <ul>
              <li>80 milliliters of Purified Water.</li>
              <li>5 drops of Jimsonweed juice.</li>
              <li>3 scales of a Shadow Lizard.</li>
              <li>10 drops of Daffodil Juice.</li>
            </ul>
          </>
        ),
        ...
        description: (
          <>
            ...
            <ul>
              <li>100 milliliters of Purified Water.</li>
              <li>5 drops of Black Jimsonweed Juice.</li>
              <li>Complete remnants of a Succubus's hair.</li>
              <li>10 grams of Feynapotter Fly Powder.</li>
              <li>5 grams of real Mummy Ashes.</li>
            </ul>
          </>
        ),
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Supplementary Ingredients:</p>
            <ul>
              <li>30 milliliters of Flower-Faced Bat blood.</li>
              <li>50 milliliters of a seriously ill human’s blood.</li>
              <li>Tail tip of the Two-Tailed Black Snake.</li>
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Supplementary Ingredients:</p>
            <ul>
              <li>10 millilitres of Plague Mother Serpent's Bile.</li>
              <li>Three fragments of the Silver Hunter.</li>
              <li>A fresh branch of mistletoe.</li>
              <li>
                10 millilitres of blood from seven victims who died from
                different plagues.
              </li>
            </ul>
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Supplementary Ingredients:</p>
            <ul>
              <li>Nine Mirror God Fragments.</li>
              <li>80 milliliters of Gorgon Blood.</li>
              <li>
                An antique mirror over 500 years old with a corresponding mirror
                realm.
              </li>
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Main Ingredients:</p>
            <ul>
              <li>An Apocalypse Beyonder Characteristic.</li>
            </ul>

            <p>Supplementary Ingredients:</p>
            <ul>
              <li>A piece of completely lifeless darkness.</li>
              <li>81 people obsessed with themselves.</li>
              <li>One self-created ongoing apocalypse scenario.</li>
            ...
            <ol>
              ...
              <li>
                Advance during the signs and process of the apocalypse's
                arrival.
              </li>
              <li>
                Advance when one's own involvement leads to the fall of a deity.
              </li>
            </ol>
          </>
        ),
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Main Ingredients:</p>
            <ul>
              <li>The Demoness Uniqueness.</li>
              <li>
                All other Apocalypse Beyonder Characteristics apart from one's
                own.
              </li>
            </ul>
            ...
            <ol>
              <li>
                ...
                Chaos Sea, endure a degree of its corruption while maintaining
                oneself—neither falling nor transforming.
              </li>
              <li>
                Alternative Ritual: Find a way to borrow the special traits from
                the Sequence 1s of five Pathways related to the Chaos Sea,
                combine them into a power close to the Chaos Sea, and control
                it.
              </li>
            </ol>
          </>
  ...
  // Black Emperor
  {
    ...
    neighbors: [
      {
        id: 20,
        iconOff: require("../assets/iconOff/20_Off.png"),
    ...
    sequences: [
      {
        ...
        description: (
          <>
            ...
            <p>Main Ingredients:</p>
            <ul>
              <li>A Lawyer Beyonder Characteristic.</li>
            </ul>
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Supplementary Ingredients:</p>
            <ul>
              <li>1 Deep-Grained Walnut.</li>
              <li>1 Fragrance Hornet Grass.</li>
              <li>
                10 milliliters of the extract obtained from soaking poplar bark.
              </li>
              <li>100 milliliters of Liquor.</li>
            </ul>
          </>
        ),
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Supplementary Ingredients:</p>
            <ul>
              <li>5 drops of Golden Jimsonweed Juice.</li>
              <li>5 drops of Black Jimsonweed Juice.</li>
              <li>4 drops of Fantasy Grass Essential Oil.</li>
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Main Ingredients:</p>
            <ul>
              <li>A Baron of Corruption Beyonder Characteristic.</li>
            </ul>
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Main Ingredients:</p>
            <ul>
              <li>A Mentor of Disorder Beyonder Characteristic.</li>
            </ul>
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Main Ingredients:</p>
            <ul>
              <li>A Frenzied Mage Beyonder Characteristic.</li>
            </ul>
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Main Ingredients:</p>
            <ul>
              <li>A Duke of Entropy Beyonder Characteristic.</li>
            </ul>
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Main Ingredients:</p>
            <ul>
              <li>A Prince of Abolition Beyonder Characteristic.</li>
            </ul>
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Main Ingredients:</p>
            <ul>
              <li>The Black Emperor Uniqueness.</li>
              <li>
                All other Prince of Abolition Beyonder Characteristics apart
                from one's own.
              </li>
            </ul>
            ...
            <ol>
              <li>
                ...
                Emperor and making it common knowledge among the populace.
              </li>
              <li>
                Establish a set of strict and complicated rules that defy
                normality, including architectural styles.
              </li>
              <li>
                Spur your citizens to secretly establish nine mausoleums in the
                style of pyramids.
              </li>
              <li>Enter one of the mausoleums.</li>
              <li>
                Drink the potion while a large majority of the citizens are
                scattered across different cities in the corresponding
                sacrificial rituals involved.
              </li>
            </ol>
          </>
        ),
  ...
  // Tyrant
  {
    ...
    neighbors: [
      {
        id: 11,
        iconOff: require("../assets/iconOff/11_Off.png"),
        iconColor: require("../assets/iconColor/11_Color.png"),
      },
      {
        id: 12,
        iconOff: require("../assets/iconOff/12_Off.png"),
        iconColor: require("../assets/iconColor/12_Color.png"),
      },
      {
        id: 16,
        iconOff: require("../assets/iconOff/16_Off.png"),
        iconColor: require("../assets/iconColor/16_Color.png"),
      },
      {
        id: 19,
        iconOff: require("../assets/iconOff/19_Off.png"),
    ...
    sequences: [
      {
        ...
        description: (
          <>
            ...
            <p>Supplementary Ingredients:</p>
            <ul>
              <li>300 milliliters of strong liquor.</li>
              <li>200 milliliters of seawater.</li>
              <li>3 Murloc scales.</li>
              <li>12 drops of seaweed extract.</li>
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Supplementary Ingredients:</p>
            <ul>
              <li>500 milliliters of strong liquor.</li>
              <li>Half of a deep-diver’s tongue.</li>
              <li>A segment of a War-cry bird's beak.</li>
              <li>10 drops of red algae essential oil.</li>
            </ul>
          </>
        ),
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <ul>
              <li>500 milliliters of strong liquor.</li>
              <li>One black-scaled shark fin.</li>
              <li>100 milliliters of raging white dolphin’s blood.</li>
              <li>A branch of blue star coral.</li>
              <li>One crystal.</li>
            </ul>
          </>
        ),
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Supplementary Ingredients:</p>
            <ul>
              <li>500 milliliters of high-purity liquor.</li>
              <li>One Blue Shadow Falcon bone.</li>
              <li>Two Dragon-Eyed Sea Condor feathers.</li>
              <li>30 milliliters of rainwater untouched by the ground.</li>
              <li>
                A breeze captured when the sun has lit the horizon but not yet
                risen.
              </li>
            </ul>
          </>
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <ul>
              <li>500 milliliters of high-purity liquor.</li>
              <li>5 strands of Siren hair.</li>
              <li>5 tentacles of the Crystal Jellyfish.</li>
              <li>One tide-shell.</li>
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Supplementary Ingredients:</p>
            <ul>
              <li>500 milliliters of the whale’s gastric fluid.</li>
              <li>One tentacle of the Vortex Terror-Beast.</li>
              <li>50 milliliters of water from the “Spring of the Elves”.</li>
              <li>10 drops of mucus from a deep-diver leader.</li>
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Supplementary Ingredients:</p>
            <ul>
              <li>600 milliliters of the King of Green Wings’ blue blood.</li>
              <li>One fang of the Deep-Sea Python.</li>
              <li>A small idol imbued with Sea God faith.</li>
              <li>10 drops of paste made from over 100 kinds of fish roe.</li>
            ...
            <p>
              ...
              creatures within a 300-nautical-mile radius.
            </p>
          </>
        ),
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Main Ingredients:</p>
            <ul>
              <li>Beyonder Characteristic of Queen of Calamity Cohinem.</li>
              <li>
            ...
            <p>Supplementary Ingredients:</p>
            <ul>
              <li>An item from the remains of a historic disaster.</li>
              <li>
                600 ml of the King of the Deep Sea’s or another Calamity’s
                blood.
              </li>
              <li>3 leaves of the Elven Ancestor Tree.</li>
            ...
            <p>
              ...
              despair, reveal yourself and halt the disaster—this stage must
              also rely solely on your own power.
            </p>
          </>
        ),
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Main Ingredients:</p>
            <ul>
              <li>A Thunder God Beyonder Characteristic.</li>
            </ul>
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Main Ingredients:</p>
            <ul>
              <li>The Tyrant Symbol2 Tyrant Uniqueness.</li>
              <li>
                All other Thunder God Beyonder Characteristics apart from one's
                own.
              </li>
            </ul>
            ...
            <ol>
              <li>
                ...
                the person out of fear.
              </li>
              <li>Challenge a Sequence 0 True God and survive.</li>
              <li>
                After surviving the challenge, drink the potion under the watch
                of the fearful followers.
              </li>
            </ol>
          </>
        ),
        ...
        description: (
          <>
            ...
            <ul>
              ...
              <li>Nail fragments from Nine Different Individuals.</li>
              <li>1 Sapphire.</li>
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Supplementary Ingredients:</p>
            <ul>
              <li>100 milliliters of Pure Water.</li>
              <li>20 milliliters of Another’s Tears.</li>
              <li>1 Lapis Lazuli.</li>
              <li>10 grams of White Chestnut Balm.</li>
            </ul>
          </>
        ),
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Supplementary Ingredients:</p>
            <ul>
              <li>80 milliliters of Sphinx Blood.</li>
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Supplementary Ingredients:</p>
            <ul>
              <li>100 milliliters of Freshly Stolen Wine.</li>
              <li>10 grams of Cloaked Specter residue.</li>
              <li>1 Citrine.</li>
              <li>10 drops of Larch Essential Oil.</li>
              <li>1 Ignited Flame.</li>
            </ul>
          </>
        ),
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Supplementary Ingredients:</p>
            <ul>
              <li>30 milliliters of Dream‑Eating Rat Blood.</li>
              <li>30 milliliters of De‑spiritualized Decaying Breath.</li>
              <li>1 Celestine.</li>
              <li>10 drops of Lavender Hydrosol.</li>
              <li>
                50 milliliters of Tears Shed by Someone with Shattered Ideals.
              </li>
            </ul>
            ...
            <p>
              ...
              dreams last, what matters is that they are happening when the
              potion is consumed.
            </p>
          </>
        ),
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Supplementary Ingredients:</p>
            <ul>
              <li>100 milliliters of Soul‑Snatcher’s Blood.</li>
              <li>9 drops of Puppet Parasitic Worm secretions.</li>
              <li>1 Amethyst.</li>
              <li>10 drops of Cherry Plum Juice.</li>
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Supplementary Ingredients:</p>
            <ul>
              <li>80 milliliters of Swamp Giant’s Blood.</li>
              <li>20 grams of Blasphemous Priest’s fungal shroud.</li>
              <li>30 grams of Gold.</li>
              <li>10 drops of Violet Puredew.</li>
              <li>
                9 Spirit World Wraiths who died due to the aspirant’s Deceit.
              </li>
            </ul>
            ...
            <p>
              ...
              smaller than a village, the smallest entity that can form a
              projection in the Spirit World.
            </p>
          </>
        ),
        ...
        description: (
          <>
            ...
            <p>
              ...
              circle’s trust until the identity dies naturally.
            </p>
          </>
        ),
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Supplementary Ingredients:</p>
            <ul>
              <li>1 Ancient Clock.</li>
              <li>1 Used Almanac.</li>
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Main Ingredients:</p>
            <ul>
              <li>The Error Uniqueness.</li>
              <li>
                All other Worm of Time Beyonder Characteristics apart from one's
                own.
              </li>
            </ul>
  ...
  // Red Priest
  {
    ...
    neighbors: [
      {
        id: 3,
        iconOff: require("../assets/iconOff/3_Off.png"),
    ...
    sequences: [
      {
        ...
        description: (
          <>
            ...
            <p>Main Ingredients:</p>
            <ul>
              <li>A Hunter Beyonder Characteristic.</li>
            </ul>
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Main Ingredients:</p>
            <ul>
              <li>A Provoker Beyonder Characteristic.</li>
            </ul>

            <p>Supplementary Ingredients:</p>
            <ul>
              <li>50 milliliters of Distilled Liquor.</li>
              <li>10 drops of Honeysuckle Extract.</li>
              <li>5 grams of Grapevine Powder.</li>
              <li>10 grams of Aqua Fern Grass Powder.</li>
            </ul>
          </>
        ),
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Supplementary Ingredients:</p>
            <ul>
              <li>50 milliliters of Fire Salamander blood.</li>
              <li>10 grams of Magma Pyroxene Powder.</li>
              <li>10 grams of Redcrown Balsam Powder.</li>
              <li>10 drops of Sun Star extract.</li>
            </ul>
          </>
        ),
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Supplementary Ingredients:</p>
            <ul>
              <li>1 Black Hunting Spider's Poison Gland.</li>
              <li>80 milliliters of Sphinx Blood.</li>
              <li>10 grams of Amber Powder.</li>
              <li>2 White Oak Fruits.</li>
            </ul>
          </>
        ),
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <ul>
              <li>
                80 milliliters of Gray Demonic Wolf's blood or the Reaper
                Beyonder Characteristic's predecessor’s blood.
              </li>
              <li>
                2 fangs of the Forest Hunter or the predecessor’s 2 teeth.
              </li>
              <li>10 drops of Colorful Bearded Horned Lizard Venom.</li>
            ...
            <p>
              ...
              and consume the potion as they witness your victory, filled with
              fear and despair.
            </p>
          </>
        ),
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Supplementary Ingredients:</p>
            <ul>
              <li>80 milliliters of boiling magma.</li>
              <li>
                20 grams of flora powder corrupted by a Stone of Catastrophe.
              </li>
              <li>
                20 grams of soil soaked in soldier's blood from a large
                battlefield.
              </li>
              <li>1 acorn.</li>
            </ul>
            ...
            <p>
              ...
              strength and tacit understanding of the team, the better the
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Supplementary Ingredients:</p>
            <ul>
              <li>100 milliliters of Bipolar Centaur Blood.</li>
              <li>War Comet Fragments.</li>
              <li>1 Blood Tudor Iris.</li>
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <ul>
              <li>
                30 milliliters of blood each from three deceased individuals who
                died in different extreme weather conditions.
              </li>
              <li>500 strands of a Weather Giant's hair.</li>
              <li>Five Mist Jellyfish Crystals.</li>
              <li>A segment of a tree branch struck by lightning.</li>
              <li>
                20 milliliters of the first snow melt of a region each year.
              </li>
            </ul>
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Main Ingredients:</p>
            <ul>
              <li>A Conqueror Beyonder Characteristic.</li>
            </ul>

            <p>Supplementary Ingredients:</p>
            <ul>
              <li>
                90 milliliters of blood from a Conqueror or contaminated liquid
                from a Conqueror Beyonder Characteristic.
              </li>
              <li>A genuine crown.</li>
              <li>
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Main Ingredients:</p>
            <ul>
              <li>The Red Priest Uniqueness.</li>
              <li>
                All other Conqueror Beyonder Characteristics apart from one's
                own.
              </li>
            </ul>
            ...
            <ul>
              <li>
                One’s own nation’s deep projection within the Mirror World.
              </li>
            </ul>
    ...
    sequences: [
      {
        ...
        description: (
          <>
            ...
            <ul>
              <li>
                One Giant Warrior's Muscle Core,
                <br />
            ...
            <ul>
              <li>
                100 milliliters of a Giant Warrior's blood or 100 milliliters of
                Mutated Black Bear's blood.
              </li>
              <li>
                A Giant Warrior's Heart or the Heart of a Bloodthirsty
                Rhinoceros.
              </li>
              <li>10 drops of Sweet Basil Essential Oil.</li>
              <li>1 piece of Onyx.</li>
            </ul>
          </>
        ),
        card: require("../assets/cards/0_Card.webp"),
      },
      {
        ...
        description: (
          <>
            ...
            <ul>
              <li>
                The metacarpal bone of a Giant Squire,
                <br />
                The heart of a Giant Black Bear,
                <br />
            ...
            <ul>
              <li>
                100 milliliters of a Giant Squire's Blood or 100 milliliters of
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <ul>
              <li>
                One Spine of a Blue Giant,
                <br />
                The left Paw of an Iron Bear,
                <br />
            ...
            <ul>
              <li>
                100 milliliters of Blue Giant's Blood or 100 milliliters of an
                Iron Bear's Blood.
              </li>
              <li>
                10 strands of hair from a Blue Giant or 20 strands of hair from
                a Six-Armed Gray Ape.
              </li>
              <li>10 arrows dug up from a battlefield.</li>
              <li>A tuft of hair from the person they have defeated.</li>
            </ul>
          </>
        ),
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <ul>
              <li>
                The Blood Crystal of a Dawn Giant,
                <br />
                The Breastbone of a Dawn Bird,
                <br />
            ...
            <ul>
              <li>
                100 milliliters of a Dawn Giant's Brain Fluid or 100 milliliters
                of Silver Bear's Bile.
              </li>
              <li>3 pieces of Dawn Giant's Nail or one Dawn Bird's Claw.</li>
              <li>One Opal.</li>
              <li>One Purified Item.</li>
            </ul>
          </>
        ),
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <ul>
              <li>
                The Heart of a Gray Giant,
                <br />
                The Core of the Stone Giant,
                <br />
            ...
            <ul>
              <li>
                200 milliliters of a Gray Giant's blood or 200 grams of Stone
                Giant's Dust mixed with pure water.
              </li>
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <ul>
              <li>
                The Eye of a Divine Giant,
                <br />
                The Heart of a Dragon-Eater,
                <br />
            ...
            <ul>
              <li>
                200 milliliters of blood from a Divine Giant or 200 milliliters
                of blood from a Dragon Eater.
              </li>
              <li>
                1 Skull of a Divine Giant or 1 Skull of an Evil Spirit Hunter.
              </li>
              <li>49 different types of monster parts or herbs.</li>
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <ul>
              <li>
                The essence of Aurmir's blood,
                <br />
                Or the Heart of a "King's Court Chaser",
                <br />
            ...
            <ul>
              <li>
                300 milliliters of water contaminated by the power of Death.
              </li>
              <li>
                One item worn or carried by a Sequence 3 or above from the
                Twilight Giant Pathway.
              </li>
              <li>One piece of Amber with a trapped ancient insect inside.</li>
              <li>
                One piece of paper recording 100 or more kills of oneself.
              </li>
            </ul>
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Supplementary Ingredients:</p>
            <ul>
              <li>300 milliliters of blood from the Glorious Giant.</li>
              <li>One item corrupted by Dark Power.</li>
              <li>One corpse buried for over a thousand years.</li>
              <li>
                One poem praising oneself
                <br />
                <em>(It has to be sung for at least 10 years)</em>
              </li>
            </ul>
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Supplementary Ingredients:</p>
            <ul>
              <li>100 milliliters of a True God's Blood.</li>
              <li>9 drops of Water from the River Styx.</li>
              <li>
                A religious text recording one's own legend and deeds of
                loyalty.
              </li>
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <p>Main Ingredients:</p>
            <ul>
              <li>The Twilight Giant Uniqueness.</li>
              <li>
                All other Hand of God Beyonder Characteristics apart from one's
                own.
              </li>
            </ul>
  ...
  // Hermit
  {
    ...
    neighbors: [
      {
        id: 2,
        iconOff: require("../assets/iconOff/2_Off.png"),
  ...
  // Visionary
  {
    ...
    neighbors: [
      {
        id: 5,
        iconOff: require("../assets/iconOff/5_Off.png"),
        iconColor: require("../assets/iconColor/5_Color.png"),
      },
      {
        id: 12,
        iconOff: require("../assets/iconOff/12_Off.png"),
  ...
  // Death
  {
    ...
    neighbors: [
      {
        id: 8,
        iconOff: require("../assets/iconOff/8_Off.png"),
        iconColor: require("../assets/iconColor/8_Color.png"),
      },
      {
        id: 17,
        iconOff: require("../assets/iconOff/17_Off.png"),
  ...
  // Chained
  {
    ...
    neighbors: [
      {
        id: 15,
        iconOff: require("../assets/iconOff/15_Off.png"),
  ...
  // Abyss
  {
    ...
    neighbors: [
      {
        id: 14,
        iconOff: require("../assets/iconOff/14_Off.png"),
  ...
  // Moon
  {
    ...
    neighbors: [
      {
        id: 21,
        iconOff: require("../assets/iconOff/21_Off.png"),
  ...
  // Justiciar
  {
    ...
    neighbors: [
      {
        id: 4,
        iconOff: require("../assets/iconOff/4_Off.png"),
  ...
  // Mother
  {
    ...
    neighbors: [
      {
        id: 18,
        iconOff: require("../assets/iconOff/18_Off.png"),
